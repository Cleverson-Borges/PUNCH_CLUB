...
class ControladorTorneio:
    ...
    def alterar_torneio(self):
        if self.__torneio_atual:
            ...
            self.__torneio_atual.numero_lutas = numero_lutas
        else:
    ...
    def mostrar_luta_usuario(self, boxeador_um, boxeador_dois):
        self.__tela_torneio.mostrar_luta_usuario(self.torneio_atual.nome_torneio,boxeador_um, boxeador_dois, self.__fase_atual)
